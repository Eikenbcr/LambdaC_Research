#define StatisticalUncertainty_cxx
#include "StatisticalUncertainty.h"
...
void StatisticalUncertainty::Begin(TTree * /*tree*/)
{

   TString option = GetOption();
}

void StatisticalUncertainty::SlaveBegin(TTree * /*tree*/)
{
   TString option = GetOption();
...
Bool_t StatisticalUncertainty::Process(Long64_t entry)
{
...
void StatisticalUncertainty::SlaveTerminate()
{
}

void StatisticalUncertainty::Terminate()
{
