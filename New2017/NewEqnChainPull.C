...
// The class definition in NewEqnChainPull.h has been generated automatically
...
//
// root> T->Process("NewEqnChainPull.C")
// root> T->Process("NewEqnChainPull.C","some options")
// root> T->Process("NewEqnChainPull.C+")
//
