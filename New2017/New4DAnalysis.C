#define New4DAnalysis_cxx
#include "New4DAnalysis.h"
...
void New4DAnalysis::Begin(TTree * /*tree*/)
{
   TString option = GetOption();
}

void New4DAnalysis::SlaveBegin(TTree * /*tree*/)
{
...
Bool_t New4DAnalysis::Process(Long64_t entry)
{
  GetEntry(entry);
...
double FOMK = fomK[p][q];
double FOMPi = fomK[m][n];
...
void New4DAnalysis::SlaveTerminate()
{
}

void New4DAnalysis::Terminate()
{
