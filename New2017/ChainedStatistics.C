...
// The class definition in ChainedStatistics.h has been generated automatically
...
//
// root> T->Process("ChainedStatistics.C")
// root> T->Process("ChainedStatistics.C","some options")
// root> T->Process("ChainedStatistics.C+")
//
