#define New1DAnalysis_cxx
#include "New1DAnalysis.h"
...
void New1DAnalysis::Begin(TTree * /*tree*/)
{
   TString option = GetOption();
}

void New1DAnalysis::SlaveBegin(TTree * /*tree*/)
{
...
Bool_t New1DAnalysis::Process(Long64_t entry)
{
...
void New1DAnalysis::SlaveTerminate()
{

}

void New1DAnalysis::Terminate()
{
