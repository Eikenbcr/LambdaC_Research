...
// Thu May 14 15:11:47 2020 by ROOT version 6.16/00
// from TTree DecayTree/DecayTree
// found on file: MergedLc2XimKpPip.root
//////////////////////////////////////////////////////////

#ifndef StatisticalUncertainty_h
#define StatisticalUncertainty_h
...
class StatisticalUncertainty : public TSelector {
public :
   ...
   TTreeReaderValue<Double_t> Lambda_cplus0_ENDVERTEX_X = {fReader, "Lambda_cplus0_ENDVERTEX_X"};
   TTreeReaderValue<Double_t> Lambda_cplus0_ENDVERTEX_Y = {fReader, "Lambda_cplus0_ENDVERTEX_Y"};
   TTreeReaderValue<Double_t> Lambda_cplus0_ENDVERTEX_Z = {fReader, "Lambda_cplus0_ENDVERTEX_Z"};
   TTreeReaderValue<Double_t> Lambda_cplus0_ENDVERTEX_XERR = {fReader, "Lambda_cplus0_ENDVERTEX_XERR"};
   TTreeReaderValue<Double_t> Lambda_cplus0_ENDVERTEX_YERR = {fReader, "Lambda_cplus0_ENDVERTEX_YERR"};
   TTreeReaderValue<Double_t> Lambda_cplus0_ENDVERTEX_ZERR = {fReader, "Lambda_cplus0_ENDVERTEX_ZERR"};
   TTreeReaderValue<Double_t> Lambda_cplus0_ENDVERTEX_CHI2 = {fReader, "Lambda_cplus0_ENDVERTEX_CHI2"};
   TTreeReaderValue<Int_t> Lambda_cplus0_ENDVERTEX_NDOF = {fReader, "Lambda_cplus0_ENDVERTEX_NDOF"};
   TTreeReaderValue<Double_t> Lambda_cplus0_OWNPV_X = {fReader, "Lambda_cplus0_OWNPV_X"};
   TTreeReaderValue<Double_t> Lambda_cplus0_OWNPV_Y = {fReader, "Lambda_cplus0_OWNPV_Y"};
   TTreeReaderValue<Double_t> Lambda_cplus0_OWNPV_Z = {fReader, "Lambda_cplus0_OWNPV_Z"};
   TTreeReaderValue<Double_t> Lambda_cplus0_OWNPV_XERR = {fReader, "Lambda_cplus0_OWNPV_XERR"};
   TTreeReaderValue<Double_t> Lambda_cplus0_OWNPV_YERR = {fReader, "Lambda_cplus0_OWNPV_YERR"};
   TTreeReaderValue<Double_t> Lambda_cplus0_OWNPV_ZERR = {fReader, "Lambda_cplus0_OWNPV_ZERR"};
   TTreeReaderValue<Double_t> Lambda_cplus0_OWNPV_CHI2 = {fReader, "Lambda_cplus0_OWNPV_CHI2"};
   TTreeReaderValue<Int_t> Lambda_cplus0_OWNPV_NDOF = {fReader, "Lambda_cplus0_OWNPV_NDOF"};
   TTreeReaderValue<Double_t> Lambda_cplus0_IP_OWNPV = {fReader, "Lambda_cplus0_IP_OWNPV"};
   TTreeReaderValue<Double_t> Lambda_cplus0_IPCHI2_OWNPV = {fReader, "Lambda_cplus0_IPCHI2_OWNPV"};
   TTreeReaderValue<Double_t> Lambda_cplus0_FD_OWNPV = {fReader, "Lambda_cplus0_FD_OWNPV"};
   TTreeReaderValue<Double_t> Lambda_cplus0_FDCHI2_OWNPV = {fReader, "Lambda_cplus0_FDCHI2_OWNPV"};
   TTreeReaderValue<Double_t> Lambda_cplus0_DIRA_OWNPV = {fReader, "Lambda_cplus0_DIRA_OWNPV"};
   TTreeReaderValue<Double_t> Lambda_cplus0_P = {fReader, "Lambda_cplus0_P"};
   TTreeReaderValue<Double_t> Lambda_cplus0_PT = {fReader, "Lambda_cplus0_PT"};
   TTreeReaderValue<Double_t> Lambda_cplus0_PE = {fReader, "Lambda_cplus0_PE"};
   TTreeReaderValue<Double_t> Lambda_cplus0_PX = {fReader, "Lambda_cplus0_PX"};
   TTreeReaderValue<Double_t> Lambda_cplus0_PY = {fReader, "Lambda_cplus0_PY"};
   TTreeReaderValue<Double_t> Lambda_cplus0_PZ = {fReader, "Lambda_cplus0_PZ"};
   TTreeReaderValue<Double_t> Lambda_cplus0_MM = {fReader, "Lambda_cplus0_MM"};
   TTreeReaderValue<Double_t> Lambda_cplus0_MMERR = {fReader, "Lambda_cplus0_MMERR"};
   TTreeReaderValue<Double_t> Lambda_cplus0_M = {fReader, "Lambda_cplus0_M"};
   TTreeReaderValue<Int_t> Lambda_cplus0_ID = {fReader, "Lambda_cplus0_ID"};
   TTreeReaderValue<Double_t> Lambda_cplus0_TAU = {fReader, "Lambda_cplus0_TAU"};
   TTreeReaderValue<Double_t> Lambda_cplus0_TAUERR = {fReader, "Lambda_cplus0_TAUERR"};
   TTreeReaderValue<Double_t> Lambda_cplus0_TAUCHI2 = {fReader, "Lambda_cplus0_TAUCHI2"};
   TTreeReaderValue<Bool_t> Lambda_cplus0_L0Global_Dec = {fReader, "Lambda_cplus0_L0Global_Dec"};
   TTreeReaderValue<Bool_t> Lambda_cplus0_L0Global_TIS = {fReader, "Lambda_cplus0_L0Global_TIS"};
   TTreeReaderValue<Bool_t> Lambda_cplus0_L0Global_TOS = {fReader, "Lambda_cplus0_L0Global_TOS"};
   TTreeReaderValue<Bool_t> Lambda_cplus0_Hlt1Global_Dec = {fReader, "Lambda_cplus0_Hlt1Global_Dec"};
   TTreeReaderValue<Bool_t> Lambda_cplus0_Hlt1Global_TIS = {fReader, "Lambda_cplus0_Hlt1Global_TIS"};
   TTreeReaderValue<Bool_t> Lambda_cplus0_Hlt1Global_TOS = {fReader, "Lambda_cplus0_Hlt1Global_TOS"};
   TTreeReaderValue<Bool_t> Lambda_cplus0_Hlt1Phys_Dec = {fReader, "Lambda_cplus0_Hlt1Phys_Dec"};
   TTreeReaderValue<Bool_t> Lambda_cplus0_Hlt1Phys_TIS = {fReader, "Lambda_cplus0_Hlt1Phys_TIS"};
   TTreeReaderValue<Bool_t> Lambda_cplus0_Hlt1Phys_TOS = {fReader, "Lambda_cplus0_Hlt1Phys_TOS"};
   TTreeReaderValue<Double_t> Lambda_cplus0_X = {fReader, "Lambda_cplus0_X"};
   TTreeReaderValue<Double_t> Lambda_cplus0_Y = {fReader, "Lambda_cplus0_Y"};
   ...
   StatisticalUncertainty(TTree * /*tree*/ =0) { }
   virtual ~StatisticalUncertainty() { }
   ...
   ClassDef(StatisticalUncertainty,0);

};

#endif

#ifdef StatisticalUncertainty_cxx
void StatisticalUncertainty::Init(TTree *tree)
{
...
Bool_t StatisticalUncertainty::Notify()
{
...
#endif // #ifdef StatisticalUncertainty_cxx
