...
void HalfChainPull::Begin(TTree * /*tree*/)
{
   TString option = GetOption();
}

void HalfChainPull::SlaveBegin(TTree * /*tree*/)
{
   TString option = GetOption();
...
Bool_t HalfChainPull::Process(Long64_t entry)
{
   GetEntry(entry);
...
void HalfChainPull::SlaveTerminate()
{
}

void HalfChainPull::Terminate()
{
  Double_t sigma;
  Double_t deltaSigma;
  Double_t mu;
