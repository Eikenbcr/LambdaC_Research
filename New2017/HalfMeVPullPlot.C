...
#include "HalfDGOneMuOneTotal.C"
#include "HalfDGTwoMuTwoTotals.C"
#include "HalfDGTwoMuOneTotal.C"
...
void HalfMeVPullPlot::Begin(TTree * /*tree*/)
{

   TString option = GetOption();

         SGTest = new TH1D("Mass [MeV]", "Lc_MM - Single Gaussian", 400, 2185, 2385);
         SGTest->GetXaxis()->SetTitle("MeV");
         SGTest->GetYaxis()->SetTitle("Events Per 0.5 MeV");

         DG1M1TTest = new TH1D("Mass [MeV]", "Lc_MM - Double Gaussian w/ One Mean and One Total", 400, 2185, 2385);
         DG1M1TTest->GetXaxis()->SetTitle("MeV");
         DG1M1TTest->GetYaxis()->SetTitle("Events Per 0.5 MeV");

         DG1M2TTest = new TH1D("Mass [MeV]", "Lc_MM - Double Gaussian w/ One Mean and Two Totals", 400, 2185, 2385);
         DG1M2TTest->GetXaxis()->SetTitle("MeV");
         DG1M2TTest->GetYaxis()->SetTitle("Events Per 0.5 MeV");

         DG2M1TTest = new TH1D("Mass [MeV]", "Lc_MM - Double Gaussian w/ Two Means and One Total", 400, 2185, 2385);
         DG2M1TTest->GetXaxis()->SetTitle("MeV");
         DG2M1TTest->GetYaxis()->SetTitle("Events Per 0.5 MeV");

         DG2M2TTest = new TH1D("Mass [MeV]", "Lc_MM - Double Gaussian w/ Two Means and Two Totals", 400, 2185, 2385);
...
void HalfMeVPullPlot::SlaveBegin(TTree * /*tree*/)
{
...
Bool_t HalfMeVPullPlot::Process(Long64_t entry)
{
  GetEntry(entry);
...
void HalfMeVPullPlot::SlaveTerminate()
{

}

void HalfMeVPullPlot::Terminate()
{
  Double_t sigma;
  Double_t deltaSigma;
  Double_t mu;
...
//////////////////////////////////////////////////////////////////////////////////////////
  ...
  TF1 *SingleGaussian = new TF1("SingleGaussian",fitHalfMeV_Gaussian,2100.,2500.,5);
...
pad2->cd();
TGraph* PullPlot1 = new TGraph(400,Pullx, Pull1);
PullPlot1->GetXaxis()->SetLimits(0,400);
...
TF1 *DG1Mu2Tot = new TF1("DG1Mu2Tot",HalfDGOneMuTwoTotal,2100.,2500.,7);
DG1Mu2Tot->SetParameter(0, 2000.);
DG1Mu2Tot->SetParLimits(0, 0, 10000);
DG1Mu2Tot->SetParameter(1, 2286);
DG1Mu2Tot->SetParameter(2, 5);
DG1Mu2Tot->SetParLimits(2, 0., 20.);
DG1Mu2Tot->SetParameter(3, 2000.);
DG1Mu2Tot->SetParLimits(3, 0, 10000);
DG1Mu2Tot->SetParameter(4, 5);
...
pad2->cd();
TGraph* PullPlot2 = new TGraph(400,Pullx, Pull2);
PullPlot2->GetXaxis()->SetLimits(0,400);
...
TF1 *DG1Mu1Tot = new TF1("DG1Mu1Tot",HalfDGOneMuOneTotal,2100.,2500.,7);
DG1Mu1Tot->SetParameter(0, 0.5);
DG1Mu1Tot->SetParameter(1, 10000);
DG1Mu1Tot->SetParameter(2, 2287.);
DG1Mu1Tot->SetParameter(3, 5);
DG1Mu1Tot->SetParameter(4, 5);
...
pad2->cd();
TGraph* PullPlot3 = new TGraph(400,Pullx, Pull3);
PullPlot3->GetXaxis()->SetLimits(0,400);
...
pad2->cd();
TGraph* PullPlot4 = new TGraph(400,Pullx, Pull4);
PullPlot4->GetXaxis()->SetLimits(0,400);
...
TF1 *DG2Mu1Tot = new TF1("DG2Mu1Tot",HalfDGTwoMuOneTotal,2100.,2500.,8);
DG2Mu1Tot->SetParameter(0, 0.5);
DG2Mu1Tot->SetParLimits(0, 0.1, 0.9);
DG2Mu1Tot->SetParameter(1, 12000);
...
pad2->cd();
TGraph* PullPlot5 = new TGraph(400,Pullx, Pull5);
PullPlot5->GetXaxis()->SetLimits(0,400);
